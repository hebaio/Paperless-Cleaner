...
class PaperlessClient:
    ...
    def get_documents_by_correspondent(self, correspondent_id):
    ...
    def get_documents_by_document_type(self, dtype_id):
        url = self._get_full_url('documents')
    ...
    def bulk_edit_correspondent(self, document_ids, new_correspondent_id):
        if not document_ids:
            return
    ...
    def bulk_edit_document_type(self, document_ids, new_dtype_id):
        if not document_ids:
            return
    ...
    def delete_correspondent(self, correspondent_id):
    ...
    def delete_document_type(self, dtype_id):
